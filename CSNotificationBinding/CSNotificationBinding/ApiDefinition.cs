...
namespace CSNotificationBinding {
	...
	public partial interface CSNotificationView {
		...
		CSNotificationView NotificationViewWithParentViewController (UIViewController viewController, UIColor tintColor, UIImage image, string message);
...
//		void SetVisible (bool showing, bool animated, NSSetEnumerator enum);
